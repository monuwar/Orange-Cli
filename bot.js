...
if (isMainThread) {
    ...
    bot.start((ctx) => {
        saveUser(ctx.from);
        ctx.replyWithHTML(`Hello! Welcome back. I'm currently tracking live traffic for you.`, mainKeyboard);
        ctx.replyWithHTML(`${emj('5229027828527309057', '⭐')} Contact Developer`, {
            reply_markup: {
                inline_keyboard: [[
